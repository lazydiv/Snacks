        ...
        <header className='sticky inline-flex backdrop-blur-md top-0 h-16 border-b border-mainBlack w-full bg-black bg-opacity-20'>
            <div className='mx-5 items-center h-full w-full text-2xl flex '>
                ...
                <div className='w-full md:w-3/6 mx-auto '>
                    <input type="text" onKeyPress={(e) => e.key === 'Enter' && setSearchValue(event.target.value)} className='w-full invisible md:visible outline-none  p-2 items-center bg-mainLightGray opacity-20 focus:opacity-100 rounded-md text-mainBlack' placeholder='type here ...'/>
                </div>
